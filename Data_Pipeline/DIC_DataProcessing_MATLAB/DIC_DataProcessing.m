...
% Load the Excel file, note: must change exported csv files to xlsx file
% NOTE: when processing data for different beams, also change x_val, y_val, z_val

% Hollow Box Aluminum 
% filepath for 1000N:
%file_path = "C:\Users\maria\Downloads\DIC_DataProcessing\HollowBox\DIC_HollowBox_1000N.xlsx";

% filepath for 4000N:
%file_path = "C:\Users\maria\Downloads\DIC_DataProcessing\HollowBox\DIC_HollowBox_4000N.xlsx";


% Small Solid Aluminum
% file path for 1000N: 
%file_path = "C:\Users\maria\Downloads\DIC_DataProcessing\SmallBox\DIC_SmallBox_1000N.xlsx";

% file path for 4000N: 
%file_path = "C:\Users\maria\Downloads\DIC_DataProcessing\SmallBox\DIC_SmallBox_4000N.xlsx";


% Large Solid Aluminum
% file path for 1000N: 
%file_path = "C:\Users\maria\Downloads\DIC_DataProcessing\LargeBox\DIC_LargeBox_1000N.xlsx";

% file path for 4000N: 
file_path = "C:\Users\maria\Downloads\DIC_DataProcessing\LargeBox\DIC_LargeBox_4000N.xlsx";
...
% % Hollow Box - coordinates to remove, note: these values change for each beam
% x_val = 44.0074;
% y_val = 41.7513;
% z_val = 483.018;

% % Small Solid - coordinates to remove:
% x_val = 12.9336;
% y_val = 23.2437;
% z_val = 528.295;

% Large Solid - coordinates to remove
x_val = 35.4785;
y_val = 17.7537;
z_val = 483.516;
